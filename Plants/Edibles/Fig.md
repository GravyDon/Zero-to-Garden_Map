...
- Sowing time: 
- Water need: 
- Sun needs: Full sun; can be grown by west or south walls 
Propagation:
- Ph Level: mildly acid, neutral, to mildly basic (PFAF)

Start to bear fruit in 3-5 years
...
## Uses
Can be prepared for medicinal purposes (PFAF): 
