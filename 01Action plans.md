...
- Create an organization schema that suits your needs
	- How is unorganized/new knowledge going to be taken in and processed? What is the timescale?
...
--- 2: ~~Construction of worm bin~~ DONE
	...
	2. Attach handles
	3. Prepare worm bedding
	4. Add worms
	5. Add initial amounts of organic waste (proportional to the amount of worms; I said fuck it)
--- 3: Sustaining of worm bin
	The functions to sustaining a worm bin are simple depending on the aims of the bin
	- For getting as many worm casings as possible, feed organic waste and water. Do this for a few months until all of the worms die due to a concentration of worm casings building up
	- For worm farming, you need to make sure that the worm bedding is processed frequently to allow for the worms the chance to propagate to a non-toxic bedding site. This requires a technique to extract the worms from the compost (either using light, chemical, or manual means), place them into a new environment, and to process the worm-toxic compost into plant materials
	- There is also the balance approach which is trying to build vertical layers for the worms to migrate which prevents the need to pick out and cultivate bait or propagation worms. Simply let the system iterate on itself ad-infinitum
--- 4: Construcction of bio-char bin
	1. Drill out 1-inch diameter holes around the base of the bin (separation of 30 degrees sounds alright. **Use the top of the spool in the garage if you can**)
	2. Drill holes in the top of the trash can 
	3. DONE (ez :3)
--- 5: Making of biochar
	This is where the cool part begins. On an advanced worm bin, with plenty of worm casings covering the top layer, Sprinkle the charcoal on top to inoculate the biochar with the bacteria that exists as a result of the decomposition process. Additionally, if more bacteria is required for the sake of inoculating native species or symbionts for specific plants, then this can be done as well. Refer to [[Inoculation Techniques]] for more details.
--- 6: Putting it all together
	Use the biochar, that is being actively implemented by potted plants, and through soil amendments directly sites for food forests. applications to the soil will of course vary; maximizing surface area and not disrupting the soil structure is key. Good luck, friend!
```
# Action Item #4: Foraging 101
##### Attributes
- Pace: slow
- Drive: social capital; capital
- Type: skill intake
	- Mode: Classes; self; friends (descending priority)

Next task: Next foraging class: Sunday, October 13th from 11:30 - 2PM = Introduction to Foraging
