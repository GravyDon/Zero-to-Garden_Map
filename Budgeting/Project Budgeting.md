...
Expenses prediction
	Type Legend:
	RB : Robiii's balcony and carport 
	BIO : Biogas digester
	KRA1 : Kratky method hydroponics testing
	KRA2 : Kratky method hydroponics rollout
	DRAFT : Drafting Table
	WORM1 : Making new, nested plastic bins worm bin
	WORM_WOW : Worm bins
